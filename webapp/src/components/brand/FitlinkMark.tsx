...
export function FitLinkMark({ size = 64, tone = 'light' }: FitLinkMarkProps) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="bgGrad" x1="0.15" y1="0" x2="0.85" y2="1" gradientUnits="objectBoundingBox">
      ...
      <rect x="11" y="34" width="6" height="28" rx="3" stroke={fg} strokeWidth="2.5" fill="none" />

      {/* Left inner plate (thick pill) */}
      <rect x="20" y="30" width="10" height="36" rx="5" stroke={fg} strokeWidth="2.5" fill="none" />

      {/* Right inner plate (thick pill) */}
      <rect x="66" y="30" width="10" height="36" rx="5" stroke={fg} strokeWidth="2.5" fill="none" />

      {/* Right outer plate (thin pill) */}
      <rect x="79" y="34" width="6" height="28" rx="3" stroke={fg} strokeWidth="2.5" fill="none" />
